...
- Any strings in portuguese language
- Menu system (hack/debug) and add multi-language support files
- Change size
- Startup license agreement and information screen to PSP interface
- Implement optimized directory browser with dynamic memory management and iterative sorting
- Replace fixed directory file limit with dynamic handling
- Implement PC1 cipher decryption routine for PSP
- README.md formatting and content
- Update makefile to support PRX/ELF builds
- Name project and version
- Optimized the file loading process in filer.c by replacing the slow custom sort with standard qsort and refactoring string comparisons. Added a dynamic loading screen to give visual feedback to the user while reading large amounts of ROMs, reducing load time for folders with many files.
- UI layout to use dynamic right-aligned text rendering; update and optimize localization strings
- Languages strings
- Strings Japanese, Portuguese, English, and Chinese to JP, PT-BR, EN, CN

### 🐛 Bug Fixes

- Initial message display
- Message in support
- Hidden Version infos menu
- Translate title
- Prevent crash when adding empty item to favorites
- (FOR BUILD CM) ) resolve startup crash and UTF-8 nickname parsing
- Handle non-standard PSP/GAME paths to prevent ERR_READ_MEMSTICK when launching emulator and browsing directories (Category Lite plugin support)
- Add Latin-1 font support and implement UTF-8 to Shift-JIS conversion utilities for PSP graphics

### 📚 Documentation

- Overhaul README with project revival details, installation guide, and feature highlights
- Add build status, release version, platform, and download badges to README
- Add release information and download links to Releases.md
- Add changelog and CI build configuration

### 🔧 Misc

- Remove obsolete changelog file
- Update PROJECT_VERSION to 1.9.00 in makefile_multi
- Add .agents directory to gitignore

### 🚀 Features

- Add automated build and release workflow and increment project version to 1.9.01
- Implement automated CI/CD build and release pipeline with GitHub Actions
